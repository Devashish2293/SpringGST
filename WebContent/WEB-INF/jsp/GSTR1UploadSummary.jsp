...
<div class="header-container">
	...
	<div id="gst-home_gstr-dashboard_gstr-gstin_gstr-sales"
		...
		<div class="upload-summary list_page">
			...
			<div class="heading">
				<div class="items--left">Upload Summary</div>
			</div>
			<div class="upload-summary--centered">
				<button class="button" id="upload-summary-btn"
					style="background-color: rgb(0, 166, 84);">Upload to GSTN</button>
			</div>
				...
				<table>
					<thead>
						<tr>
							...
							<th class="text-right">TAXABLE VALUE(Rs)</th>
							<th class="text-right">TAX LIABILITY(Rs)</th>
